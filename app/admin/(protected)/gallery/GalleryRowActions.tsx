...
import { publishGalleryItemAction, unpublishGalleryItemAction, deleteGalleryItemAction } from './actions';

interface GalleryMini {
  id: string;
  title: string;
  published: boolean;
}
...
export default function GalleryRowActions({ item }: Props) {
  ...
  function handlePublish() {
    ...
    startTransition(async () => {
      const result = item.published
        ? await unpublishGalleryItemAction(item.id)
        : await publishGalleryItemAction(item.id);
