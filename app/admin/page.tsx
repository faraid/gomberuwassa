...
export default async function AdminDashboardPage() {
  ...
  // Placeholder counts — will be replaced with real Prisma queries in later waves
  const stats = {
    publishedNews: '—',
    totalProjects: '—',
    galleryItems: '—',
    ...
    <div className="max-w-5xl mx-auto space-y-8">
      ...
      <section>
        ...
        <p className="text-xs text-gray-400 mt-2">
          Activity history will appear here once content management is active.
        </p>
      </section>
      ...
      <section>
        ...
        <div className="grid grid-cols-2 lg:grid-cols-3 gap-3">
          ...
          <QuickLink
            label="Projects"
            description="Track field projects"
            href="/admin/projects"
            icon={FolderKanban}
          />
          <QuickLink
            label="Gallery"
            description="Upload and organise images"
            href="/admin/gallery"
            icon={Images}
          />
          <QuickLink
            label="Programs"
            description="Update programme content"
            href="/admin/programs"
            icon={BookOpen}
          />
          <QuickLink
            label="Contact Submissions"
            description="View public enquiries"
            href="/admin/contact"
            icon={Mail}
          />
        </div>
